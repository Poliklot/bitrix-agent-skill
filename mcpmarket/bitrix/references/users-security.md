...
В compact-версии полный `composite-cache.md` сжат в `components-admin-ui.md`, `search-seo-ops.md` и этот security-раздел. Главное правило: **персональные данные нельзя замораживать в static HTML**.
