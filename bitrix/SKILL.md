...
- Для вопросов “все ли модули shop-core покрыты” сначала открывай `shop-core-module-inventory.md`: не обещай глубокое покрытие `sender`, `report`, `statistic`, `conversion`, `abtest`, `advertising`, `bizproc`, `webservice`, пока их отдельные references не готовы.
