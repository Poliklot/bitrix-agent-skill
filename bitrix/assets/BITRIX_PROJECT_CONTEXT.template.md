...
> Файл создаётся агентом в корне конкретного Bitrix-проекта после полного project intake. Это не справочник по Bitrix, а проверенный snapshot текущего проекта. Не хранить secrets, cookies, tokens, пароли, персональные данные, production XML/дампы и ключи лицензий.
...
3. Если задача рискованная или данные могли измениться, перепроверить факты в коде, а не верить snapshot вслепую.
